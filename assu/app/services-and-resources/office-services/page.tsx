...
const items: ContentItem[] = [
  {
    ...
    node: (
      // MOBILE ONLY
      <div className="md:hidden space-y-2 text-sm leading-relaxed mt-2">
        <p>
          We currently offer free printing through our photocopiers. Documents
  ...
  },
  {
    ...
    node: (
      // DESKTOP/TABLET ONLY
      <div className="hidden md:block space-y-2 text-base leading-relaxed">
        <p>
          We currently offer free printing through our photocopiers. Documents
          must be on a USB drive and in .pdf format. There is a limit of 8
          double-sided or 16 single-sided pages a day. After that, the regular
  ...
  },
  {
    ...
    node: (
      <div className="md:hidden space-y-2 text-sm leading-relaxed mt-2">
        <p>
          We offer a no-charge faxing service on campus. Bring your documents
          (single-sided), or email us and we can print them before faxing as
          well as the fax number you need to send to. We can also receive faxes.
        </p>
        <p className="font-medium">
          Email:{" "}
          <Link href="mailto:students.assu@utoronto.ca">
  ...
  },
  {
    ...
    title: "Cold Pop",
    node: (
      <div className="md:hidden text-sm leading-relaxed mt-2">
  ...
  },
  {
    ...
    title: "",
    node: (
      <div className="hidden md:block text-base leading-relaxed">
        We sell non-brand name pop. Cola, Diet Cola, and Ginger Ale for only
        50 cents!
      </div>
    ),
  },
  {
    ...
    node: (
      <div className="md:hidden text-sm leading-relaxed mt-2">
        We rent lockers in the basement of Sidney Smith Hall. Upper 1/2 size is
        $55 and Lower 1/2 size is $50. 1/3 size is $40. A $20 refundable key
        deposit is included in the price. Cash only.
      </div>
    ),
  },
  {
  ...
  },
  {
    ...
    node: (
      <div className="md:hidden space-y-2 text-sm leading-relaxed mt-2">
        <p>
          We have copies of term tests that students have donated over the
          years—come by to see what’s available. We’re always accepting new
          donations! Check the list of available courses below. We do not have
          hard copies of Faculty final exams; these are available online.
        </p>
        <p>
          View the course{" "}
