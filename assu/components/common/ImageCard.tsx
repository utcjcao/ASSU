...
export default function Button({
  ...
  size="sm"
    ...
    const Title = <h3 className="text-xl font-semibold drop-shadow-sm">{title}</h3>;

    const Subtitle = subtitle ? <p className="mt-1 text-sm text-white/90">{subtitle}</p> : null;
    ...
    return (
      ...
      >
        <div className={media}>
          <img src={imageSrc} alt={imageAltText} className={imgCls} />
        </div>
