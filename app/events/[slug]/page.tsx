export default function EventPagePlaceholder() {
  return (
    <div className="max-w-3xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold">Event page temporarily disabled</h1>
      <p>Build is passing while I debug the real implementation.</p>
    </div>
  );
}
