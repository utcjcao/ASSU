...
const items: ContentItem[] = [
  {
    ...
    node: (
      <Button aria-label="Explore ASSU Events">
        <a href="/get-involved/upcoming">Explore →</a>
      </Button>
    ),
  },
  {
  ...
  },
  {
    ...
    node: (
      <Button aria-label="Explore Arbor Journal">
        <a href="https://assu.ca/arbor/">Explore →</a>
      </Button>
    ),
  },
  {
    ...
    node: (
      <Button aria-label="Explore Project: Universal Minds">
        <a href="https://assu.ca/wp/get-involved/projectuniversal-minds/">
          Explore →
        </a>
      </Button>
    ),
